...
/// The expression is a [Cel](https://cel.dev/) expression that will be executed on validation by protovalidate-compatible libraries such as (protocheck)[https://github.com/Rick-Phoenix/protocheck] (for rust) or (protovalidat-es)[https://github.com/bufbuild/protovalidate-es] (for javascript).
#[derive(Debug, Clone)]
pub struct CelRule {
  pub id: Box<str>,
  pub message: Box<str>,
