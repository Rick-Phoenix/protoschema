...
///
/// Use [`enum_map`] or [`msg_map`] if the values for the map are messages or enums.
...
/// The first argument is the name of the field, followed by `<$key_type, $msg_ident>`, where $key_type is a plain ident for the type of the keys, and the $msg_ident is an ident pointing to a [`MessageBuilder`](crate::message::MessageBuilder) instance.
